  ...
  d3.json("samples.json").then((data) => {
    ...
    var barLayout = {
      ...
      annotations: [{
        ...
        y: -0.25,
        yanchor: 'center',
        text: 'This chart shows  which are the top 10 bacterial species <br> using the number of samples found in the belly button',
        showarrow: false
      }]
    };
    //console.log("hello");
    ...
    var gaugeLayout = { 
      ...
      annotations: [{
        ...
        y: 0,
        yanchor: 'center',
        text: "This gauge shows your washing frequency per week of your belly button",
        showarrow: false
      }]
    };
